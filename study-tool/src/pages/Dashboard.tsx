...
function StatCard({
  ...
  const content = (
    <div className="md-stat-card">
      ...
      {/* Divider + subtitle */}
      {sub && (
        <div className="mt-3 pt-2" style={{ borderTop: '0.5px solid var(--p3)' }}>
          <p className="flex items-center gap-1" style={{ color: 'var(--ink3)', fontSize: 'var(--text-stat)' }}>
            {sub}
          </p>
        </div>
      )}
...
function GesamtnoteWidget() {
  ...
  return (
    <section aria-labelledby="grade-heading" className="th-card" style={{ padding: '24px 26px' }}>
...
export default function Dashboard() {
  ...
  return (
    <div className="p-6 md:p-10 lg:p-12">
      ...
      {/* ── Stat cards ── */}
      <section aria-label="Lernstatistiken" className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-14">
        <StatCard
          icon={BookOpen}
          label="Aktive Module"
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-12">
        ...
        <div className="xl:col-span-2 space-y-10">
          ...
          <section aria-labelledby="chart-heading" className="th-card p-6">
            <div className="md-chart-header">
              {weekSessions.length > 0 ? (
                ...
                <div className="flex items-center justify-center text-sm py-4" style={{ color: 'var(--ink3)' }}>
          ...
          {data.sessions.filter(s => s.date >= monthAgo).length > 0 && (
            <section aria-labelledby="modtime-heading" className="th-card" style={{ padding: '24px 26px' }}>
          ...
          {activeModules.length > 0 && (
            <section aria-labelledby="modules-heading" className="th-card" style={{ padding: '24px 26px' }}>
                        ...
                        <td>
                          <div className="flex items-center gap-2">
                            <div className="w-24 th-progress-track">
                              <div
                                className="th-progress-fill"
                                style={{ width: `${docProgress}%`, background: 'var(--bl)' }}
                              />
                            </div>
          ...
          {upcomingExams.length > 0 && (
            <section aria-labelledby="exams-heading" className="th-card" style={{ padding: '24px 26px' }}>
        ...
        <div className="space-y-10">
          ...
          {/* Quick actions */}
          <section aria-labelledby="quicklinks-heading" className="th-card" style={{ padding: '24px 26px' }}>
          ...
          {upcomingDeadlines.length > 0 && (
            <section aria-labelledby="upcoming-heading" className="th-card" style={{ padding: '24px 26px' }}>
